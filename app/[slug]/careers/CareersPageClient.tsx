            ...
            <Link key={job.id} href={`/${company.slug}/careers/${job.id}`}>
               <Card
                ...
                <CardHeader className="pb-4">
                  <CardTitle className="text-xl font-semibold leading-tight group-hover:text-current transition-colors" style={{'--tw-text-opacity': '1'} as React.CSSProperties} onMouseEnter={(e) => e.currentTarget.style.color = company.primaryColor} onMouseLeave={(e) => e.currentTarget.style.color = ''}>
                    {job.title}
                  </CardTitle>
                </CardHeader>
